        ...
        <div className="container px-4 py-16 mx-auto lg:flex lg:items-center lg:justify-between">
            ...
            <div className="mt-8 lg:mt-0">
                <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:-mx-2">
                    ...
                    <button type='submit' className="px-4 py-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-700 rounded-md focus:ring focus:ring-blue-300 focus:ring-opacity-80 my-2 sm:my-0 sm:mx-2 hover:bg-blue-600 focus:outline-none focus:bg-blue-600" style={buttonColor&&{backgroundColor:buttonColor}}>
                        {buttonText}
                    </button>
                    </form>
                </div>
