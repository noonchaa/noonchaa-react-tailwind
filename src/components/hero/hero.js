...
const Hero = ({children,stack,fullBG}) => {
    return(
        fullBG?
        <section data-testid='fullBG' className='w-full bg-center bg-cover min-h-[32rem]' style={{backgroundImage:`url(${fullBG})`}}>
        ...
        :stack?
        <section data-testid='stack' className='bg-slate-50 dark:bg-slate-800'>
        ...
        :
        <section data-testid='normal' className='bg-slate-50 dark:bg-slate-800'>
